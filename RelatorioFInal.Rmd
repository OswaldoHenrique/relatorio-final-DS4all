...
geom_line() +
geom_point() +
scale_y_continuous(breaks = pretty(publication_quant$quantidade, n = 10)) +
expand_limits(y = 0) +
labs(x = "ano", y= "publicações")+
ggtitle("Quantidade de periodicos por ano")
```
...
ggtitle("Quantidade de publicaçoes agrupadas por tipo de evento")
```
